...
public class GenCharacter {
    public static BasedCharacter setUpCharacter() {
        ...
        if (type == 1) {
            ...
            character = new PhysicalCharacter("Knight", "assets/knight.png", basedRes, basedRes);
        } else {
            character = new BattleMageCharacter("BattleMage", "assets/battlemage.png", basedRes, basedRes);
        }
